...
export default function OpenDialog() {
  ...
  <Button variant="outline" className=" bg-primary h-9 inline-flex items-center justify-center text-sm text-black rounded-sm hover:bg-Section duration-200 hover:shadow">
