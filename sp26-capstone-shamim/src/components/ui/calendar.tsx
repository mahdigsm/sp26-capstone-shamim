...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "dark:text-input group/calendar bg-background p-3 [--cell-radius:var(--radius-2xl)] [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) p-0 select-none aria-disabled:opacity-50 hover:bg-Secondary border border-gray-300 rounded-md",
          defaultClassNames.button_previous,
        ),
        button_next: cn(
          buttonVariants({ variant: buttonVariant }),
          "size-(--cell-size) p-0 select-none aria-disabled:opacity-50 hover:bg-Secondary dark:bg-card border border-gray-300 rounded-md",
